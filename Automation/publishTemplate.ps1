...
$templateContainerName = "automationtemplates"
$loc = "China North"
...
Set-AzureStorageBlobContent -Container $templateContainerName -File StartJumpboxVM.ps1 -Context $ctx -Force|Out-Null
Set-AzureStorageBlobContent -Container $templateContainerName -File StopJumpboxVM.ps1 -Context $ctx -Force|Out-Null
